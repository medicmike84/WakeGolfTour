...
class Tournament:
    ...
    def to_SQL_date(self, start_date):
        ...
        converted_date = datetime.strptime(start_date, date_type)
    ...
    def __str__(self):
        ...
        """
        csv_str = "{0},{1},{2},{3},{4},{5}".format(
            self.__tourn_id,  self.__tourn_name, self.__course_id, self.__start_date, self.__num_rounds,
            self.__num_golfers)
        return csv_str
